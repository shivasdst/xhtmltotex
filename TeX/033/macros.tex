...
\def\Authorline#1{\edef\remauthor{#1}{\iflanguage{english}{\englishfont\Large\bfseries\begin{flushright} -- \,#1\end{flushright}}{\devanagarifont\Large\bfseries --\,#1}}%
\lhead[\thepage\quad {\iflanguage{english}{\englishfont\bfseries #1}{\devanagarifont\large\bfseries #1}}]{}}

\def\retainauthsanskrit{\lhead[\thepage\quad {\devanagarifont\large\bfseries \remauthor}]{}}
