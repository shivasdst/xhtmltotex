...
\textit{sadeva saumya idamagra āsīt ekameva advitīyam \dev{।}} (\textit{Chāndogya Upaniṣad} 6.2.1)

\begin{myquote}
- ``In the beginning, dear boy, there was \textit{sat} (existence) alone, one only”. \textit{(Translation by Svami Paramarthananda)}
\end{myquote}

\textit{satyamjñānamanantam brahma \dev{।}} (\textit{Taittirīya Upaniṣad} 2.1)
