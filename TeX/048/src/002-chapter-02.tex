...
\begin{verse}
na–kāraṁ prāṇa–nāmānāṁ da–kāram analaṁ viduḥ \dev{।}\\ jātaḥ prāṇāgni–saṁyogāt tena nādo’bhidhīyate \dev{।।} 
...
Indeed, this \textit{nāda}, originating from the primordial ‘\textit{om}’ or ‘\textit{praṇava}’, is the all–pervading eternal musical sound of the universe, from which originates all beings and all speech. It is the minutest, atom–like sound\endnote{ Though I am set to prove that \textit{Nāda} is not equal to sound, I have no choice but to use the same English word for explaining Nāda, since English language is the medium of this paper. This unavoidability of using the very same English non–equivalents applies to other terms as well.}. It is identified with the bindu\endnote{ References to this \textit{Nādabindu} can be found abundantly in many compositions. For instance, a Tiruppugazh by Aruṇagirināthar ‘\textit{nādavindukalādi namo namo}’ and a \textit{kṛti} by Muttusvāmi Dīkṣitar ‘\textit{Jambūpate mām pāhi}’ (where he says \textit{anirvacanīya nādabindo})} (\textit{yato bindus tato nādaḥ}) which is the root or the centre point of the entire creation. It is undying (\textit{nitya})\endnote{ yo nādas sarva–bhūtānāṁ sarva–varṇasya cāṅkuraḥ~।\\ yo bījaṁ mantra–koṭīnāṁ taṁ nityaṁ praṇamāmy ahaṁ~।।} and inexplicable (\textit{anirvacanīya}). Empirically, it can be described as a continuous, sustained, melodious, musical sound (\textit{avicchinna, dīrgha} and \textit{madhura}). It is \textit{nāda} that gives rise to \textit{śruti}–s, and these give rise to \textit{svara}–s and these again to \textit{rāga}–s.
...
\begin{verse}
caitanyaṁ sarva–bhūtānāṁ vivṛttaṁ jagadātmanā \dev{।}\\ nādabrahma tadānandam advitīyam upāsmahe \dev{।।}
\end{verse}
...
\begin{verse}
nādopasanayā devā brahma–viṣṇu–maheśvarāḥ \dev{।}\\ bhavanty upāsitā nūnaṁ yasmād ete tadātmakāḥ \dev{।।}
\end{verse}
...
\begin{verse}
śru śravaṇe cāsya dhātoḥ ktin–pratyaya–samudbhavaḥ \dev{।}\\ śravaṇendriya–grāhyatvāt dhvanir eva śrutir bhavet \dev{।।} 
\begin{flushright}
(Bṛhaddeśī 1.3.1,2)
\end{flushright}
\end{verse}
...
\begin{verse}
Prathamaśravaṇācchabdaḥ śrūyate hrasvamātrakaḥ \dev{।}\\ Sā śrutiḥ saṁparijñeyā svarāvayavalakṣaṇā \dev{।।} 
\begin{flushright}
...
\begin{myquote}
śrutibhyaḥ syuḥ svarāḥ ṣaḍjarṣabha–gāndhāra–madhyamāḥ \dev{।}\\ pañcamo dhaivataś cātha niṣāda iti sapta te \dev{।।}\\ teṣāṁ saṁjñāḥ sa–ri–ga–ma–pa–dha–nīty aparā matāḥ \dev{।} 
...
\begin{verse}
yo’sau dhvani–viśeṣas tu svara–varṇa–vibhūṣitaḥ \dev{।}\\ rañjako jana–cittānāṁ sa ca rāga udāhṛtaḥ \dev{।।} 
...
\begin{verse}
ta–kāraḥ śaṅkaraḥ prokto la–kāraś śaktir ucyate \dev{।}\\ śiva–śakti–samāyogāt tāla ity abhidhīyate \dev{।।}
\end{verse}
...
\begin{myquote}
sva–śruti–sthāna–saṁbhūtāṁ chāyāṁ śrutyantarāśrayāṁ \dev{।}\\ svaro yad gamayed gīte gamako’sau nirūpitaḥ \dev{।।} 
