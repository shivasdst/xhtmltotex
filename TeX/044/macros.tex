...
\setotherlanguages{sanskrit,tamil}
...
\newfontfamily\tamilshrifont{ArimaMadurai-Regular}

%~ \newfontfamily\lohittamilfont[
	%~ Script=Tamil
%~ ]{Lohit-Tamil}

%~ \usepackage{polyglossia}
%~ \newfontfamily\lohittamilfont{Arial Unicode MS}
...
\def\tamil#1{{\tamilfont\texttamil{#1}}}
\def\tamilshri#1{{\tamilshrifont #1}}
%\def\lohittamil#1{{\lohittamilfont\texttamil{#1}}}
\def\devnag#1{{\dev{#1}}}
...
\def\tamilinline#1{{\fontsize{10}{12}\selectfont\tamil{#1}}}
%\def\lohittamilinline#1{{\fontsize{10}{12}\selectfont\lohittamil{#1}}}
