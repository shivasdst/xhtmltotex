...
\long\def\titlea#1{\centerline{{\fontsize{28}{30}\selectfont\textbf{#1}}}\smallskip}
\long\def\bookTitle#1{\centerline{{\fontsize{33}{35}\selectfont\textbf{#1}}}\smallskip}
\long\def\titleb#1{\centerline{{\fontsize{28}{30}\selectfont\textbf{#1}}}\vfill}
