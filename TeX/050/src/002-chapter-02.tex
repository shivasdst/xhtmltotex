...
\begin{figure}[!h]
\includegraphics[scale=.2]{images/chap2-6.jpg}
\caption{}\label{chap1-fig5}
\end{figure}
...
\begin{figure}[!h]
\includegraphics[scale=.16]{images/chap2-7.jpg}
\caption{}\label{chap1-fig6}
\end{figure}
...
\begin{verse}
\textit{yā caiṣā viśrutā rājaṁstrailokye sādhusaṁmatā \dev{।}}\\\textit{arundhatī tayāpyeṣa vasiṣṭhaḥ pṛṣṭhataḥ kṛtaḥ \dev{॥}}
\end{verse}
