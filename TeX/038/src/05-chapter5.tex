...
A brief survey of the grammatical texts in Tamil are mentioned below\endnote{}:
...
According to Tolkāppiyaṉār\endnote{} the primary sounds are thirty in number consisting of 12 vowels and 18 consonants and he excludes \textit{kuṟṟiyalikaram} and\textit{ kuṟṟiyalukaram}. Except author of \textit{Vīraccoḻiyam} who adds \textit{āytam} between vowels and consonants and takes the primary sounds to thirty one, others follow Tolkāppiyaṉār.
...
Considering the above P.S. SubrahmanyaSastri\endnote{} opines (index Subrahmanya Sastri,P.S.) that the way in which Tamil aiwas, and is\break pronounced, may have influenced the pronunciation of Sanskrit ai in the pre - Christian era.
...
The word or \textit{Col}\endnote{} in Tamil Language is defined by grammarians\endnote{} as that which conveys sense unlike Sanskrit in which a word is defined as that which has a suffix \textit{suptińantam padam} (Pā.I.IV.14).
...
\hline
 & \textit{atuceyyum} (it does) & \textit{avaiceyyum}\supskpt{\endnote{}} (they – non – human beings- do) \tabularnewline
\hline
\end{longtable}
