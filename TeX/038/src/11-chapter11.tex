...
\begin{flushleft}
Title: Sangitaratnakara of Sarangadeva\\
 Editor: Pandit S. Subrahmanya Sastri\\
 Year: 1953\\
 Publisher: The Adyar Library, Chennai
\end{flushleft}
...
The above metaphysics guides the dances and customs of Bharatanāṭyaṃ. We sanctify the stage, perform a ritual \textit{Namaste} to the earth (to Goddess Bhūmidevī) and in the dance itself we acknowledge all the directions. These deities are unique and cannot be replaced arbitrarily by others.
...
\begin{figure}
\includegraphics{"images/11-01.jpg"}
\end{figure}
