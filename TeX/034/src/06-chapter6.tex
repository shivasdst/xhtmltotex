...
\includegraphics{"images/article-6/Ashokan_Brahmi_Example.jpg"}
...
\includegraphics{"images/article-6/SatavahanaBrahmiExample.jpg"}
It reads:
...
\underline{Example of Gupta Brāhmī (widely accepted as pre-cursor to Nāgarī. script) at Sanchi:}

\includegraphics{"images/article-6/GuptaBrahmiExmple.jpg"}
...
\includegraphics{"images/article-6/NagariBrahmiTogether.jpg"}
Or Standalone Nāgarī. example, e.g.,

\includegraphics{"images/article-6/NagariExample.jpg"}
...
The Ashokan edict discoveredd by Shri Bhagwanlal Inderji at Sopara is the most outstanding example of Brāhmī found in this area. Sopara is 25 kms from Kanheri caves. This edict is currently housed at Chhatrapati Shivaji\index{Chhatrapati Shivaji} Maharaj Vastu Sangrahalaya in Mumbai.
...
\begin{figure}
\includegraphics{"images/article-6/art6-img1.jpg"}\includegraphics{"images/article-6/art6-img2.jpg"}\includegraphics{"images/article-6/art6-img3.jpg"}
...
\begin{figure}
\includegraphics{"images/article-6/TNArchNandiNagari.jpg"}
...
http://www.tnarch.gov.in/epi/ins5.htm
...
Silver Kahavanu\index{Kahavanu} of Uttama Chol 970–985 CE:

\begin{figure}
\includegraphics{"images/article-6/UttamaChola.jpg"}
...
\begin{figure}
\includegraphics{"images/article-6/YudhMalla.jpg"}
...
\begin{figure}
\includegraphics{"images/article-6/art6-img4.jpg"}
...
\begin{figure}
\includegraphics{"images/article-6/art6-img5.jpg"}
\caption{Todywalla Auctions, Mumbai}
\end{figure}
...
\begin{figure}
\includegraphics{"images/article-6/CeylonManTypeRajadhiraja.jpg"}
\caption{Classical Numismatic Gallery, Ahmedabad}
\end{figure}
...
\section*{The Alupas\index{Alupas} of Coast Karnataka}

Alupa or Alva dynasty ruled in Tulunadu region of Coastal Karnataka from 200-450 CE. They became feudatories of Kadambas\index{Kadamba} of Banavasi, then of Chaulukyas,\index{Chaulukya} Rashtrakuta,\index{Rashtrakuta} Hoysala\index{Hoysala} and later of Vijayanagar\index{Vijayanagar} empire.

Gold Pagoda of an Alupa ruler with title Shri Pandya Dhananjaya\index{Shri Pandya Dhananjaya} legend in Nāgarī, attributed to period 1088-1332

\begin{figure}
\includegraphics{"images/article-6/art6-img6.jpg"}
\caption{Todywalla Auctions, Mumbai}
\end{figure}

Alupa rulers minted coin with Nāgarī\index{Nagari@Nāgarī} legend for centuries. They also minted coins with Kannada legend simultaneously.

\underline{Coinage of Kadambas of Goa}

Gold pagodas with Nāgarī script are found in plenty from 11th century to early 13th century. They ruled from Goppakkapattan, ancient port of the present day Goa. They helped Chaulukyas to defeat Rashtrakuta. Language of Kadamba\index{Kadamba} administration was Sanskrit and \textbf{Kannada}\index{Kannada} while coins were inscribed with Nāgarī legend.

Gold pagoda of Shiva Chitta\index{Shiva Chitta} with Nāgarī legend:

\begin{figure}
\includegraphics{"images/article-6/shivaChittaKadamba.jpg"}
\caption{Wiki}
\end{figure}

\underline{Yadavas\index{Yadava} of Devagiri}

Yadavs of Devagiri ruled from their capital Devagiri – the present day Daulatabad. They ruled the regions North Karnataka and Maharashtra upto present day Madhya Pradesh from 9th to 14th Century CE. They were patron of Kannada\index{Kannada} and Sanskrit\index{Sanskrit literature} literature. Their coinages are inscribed with Nāgarī legend.

Silver Kasu\index{Kasu} of Yadava ruler Seundeva:\index{Seundeva}

\begin{figure}
\includegraphics{"images/article-6/art6-img7.jpg"}
\caption{Todywalla Auctions, Mumbai}
\end{figure}

Gold Padma Tanka\index{Padma Tanka} of Mahadeva, with Mahadeva\index{Mahadeva} in Nāgarī:

\begin{figure}
\includegraphics{"images/article-6/PadmaTankaMahadev.jpg"}
\caption{Todywalla Auctions, Mumbai}
\end{figure}
...
\begin{figure}
\includegraphics{"images/article-6/TaraHariHara.jpg"}
\caption{Classical Numismatic Gallery, Ahmedabad}
\end{figure}

Gold Double pagoda weighing 7.8g of Shri Krishna Devaraya\index{Shri Krishna Devaraya} 1509-1529 CE:

\begin{figure}
\includegraphics{"images/article-6/KrishnaDevrayaDoublePagoda.jpg"}
\caption{Todywalla Auctions, Mumbai}
\end{figure}
...
Gold Fanam of Sadasiva Raya\index{Sadasiva Raya} with clear NāgarīSa on Reverse:

\begin{figure}
\includegraphics{"images/article-6/art6-img8.jpg"}
\caption{From Bimal Trivedi Collection}
\end{figure}

Gold Half-Fanam of Devaraya II with Shri Pratapa Raya\index{Shri Pratapa Raya} in DevaNāgarī:

\begin{figure}
\includegraphics{"images/article-6/art6-img9.jpg"}
\caption{From Bimal Trivedi Collection}
\end{figure}
...
\begin{figure}
\includegraphics{"images/article-6/KrishnaDevaRayaCopperUnit.jpg"}
\caption{Classical Numismatic Gallery, Ahmedabad}
\end{figure}
...
\underline{Nāgarī’s Travel further South to Sri Lanka}
...
\begin{figure}
\includegraphics{"images/article-6/Bactrian_King_Agathokleyas.jpg"}
