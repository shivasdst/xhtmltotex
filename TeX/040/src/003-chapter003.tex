...
\begin{figure}[h]
\centering
\includegraphics[scale=1.7]{images/078.jpg}
\vskip-.3cm
\end{figure}
...
\vskip-.4cm
\centering
\includegraphics[scale=1.2]{images/079.jpg}
\vskip-.4cm
\end{wrapfigure}
...
\includegraphics[scale=2.2]{images/080.jpg}
\vskip-.5cm
\end{figure}
...
\vskip-.4cm
\centering
\includegraphics[scale=1.4]{images/081.jpg}
\vskip-.2cm
\end{wrapfigure}
...
\item Older women are at the risk of \textit{osteoporosis\index{Osteoporosis}} (weak bones) due to\break calcium deficiency and vitamin D deficiency.
...
\includegraphics[scale=1.3]{images/082.jpg}
\vskip-.4cm
\end{figure}
...
\includegraphics[scale=2.3]{images/083.jpg}
\vskip-.4cm
\end{figure}
...
\noindent\textbf{b. \textit{Autonomic Neuropathy\index{Autonomic neuropathy}}}
...
\noindent\textbf{c. \textit{Peripheral Neuropathy\index{Peripheral neuropathy}}}
...
\begin{tabular}{|l|c|}
\hline
\quad\textbf{Daily activities} & \,\,\textbf{Calorie consumption}\\
 & \quad\textbf{Per hour}\\
\hline
...
\item Reduction in blood pressure, serum lipids and \textit{hyperinsulinemia\index{Hyperinsulinaemia}}
...
These patients should first consult their doctor. They should\break indulge in physical activity and exercise once their overall health\break improves and they are considered to be fit and safe to take up exercises.

\noindent\textbf{Practicing what I preach! Walk the talk!}
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.1]{images/087.jpg}
\vskip-.5cm
\end{figure}
...
\item Tests to evaluate long–term diabetes control: These include \textit{HbA1c\index{HbA1C test}} and \textit{fructosamine test\index{Fructosamine test}}.
\end{enumerate}
...
\begin{enumerate}[i.]
\itemsep=0pt
\item \textit{HBA1c}\index{HbA1C test}
\item \textit{Fructosamine test.\index{Fructosamine test}}
\end{enumerate}
...
\noindent\textbf{The Fructosamine test\index{Fructosamine test}}
...
\noindent\textbf{a) \textit{Blood pressure\index{Blood pressure}}}
...
\noindent\textbf{b) ECG (EKG) or \textit{electrocardiography\index{ECG or Electrocardiography}}}
...
\noindent\textbf{c) \textit{Lipid profile\index{Lipid profile}}}

This should be checked annually. A fasting lipid profile is a blood test that assesses your risk for developing cardiovascular complications by measuring levels of total cholesterol, high–density lipoprotein (HDL or “good”) cholesterol, triglycerides, and \textit{low–density lipoprotein (LDL or “bad”) cholesterol\index{Low-density lipoprotein (LDL) cholesterol}}.

It is also used to diagnose \textit{“diabetic dyslipidemia”\index{\index{Diabetic dysplipidemia}}}, a condition\break characterized by high triglyceride and low \textit{HDL cholesterol\index{HDL cholesterol}} levels that is common in type 2 diabetes and increases the overall risk of heart disease. (For more information see chapter – \ref{chap13B})
...
\textbf{b) \textit{Serum Creatinine\index{Serum creatinine} and eGFR}}
...
Creatinine levels in the blood are also used to estimate \textit{GFR} or \textit{glome\-rular filtration rate\index{Glomerular filtration rate (GFR)}}. Normal GFR value is 90–125 ml/min/1.73 m2. When this level falls to 15 ml/min/1.73 m2, then the patient needs dialysis to stay alive.
...
\noindent\textbf{Tests to screen for \textit{neuropathy\index{Neuropathy}}}
...
\noindent\textbf{\textit{Ketones\index{Ketones}} and \textit{Diabetic Ketoacidosis\index{Diabetic ketoacidosis}}}
...
\noindent\textbf{When should we check for \textit{ketones?\index{Ketones}}}
...
\begin{tabular}{|l|l|l|}
\hline
\,\,\,\textbf{Tests of blood}  & \,\,\textbf{Frequency of} & \quad\textbf{Purpose of testing}\\
\,\,\textbf{glucose control}  & \,\,\,\,\quad\textbf{testing} & \\
\hline
...
The first step is to identify people at risk for developing diabetes. People who have \textit{‘prediabetes’\index{Prediabetes}} are up to 15 times more likely to develop diabetes within 10 years if no preventive actions are undertaken. This risk is much higher among Indians compared to Caucasians.

\noindent\textbf{Prediabetes is diagnosed if:}

\begin{enumerate}[•]
\itemsep=0pt
\item The fasting blood sugar level is between 100 to 125 mg per deci\-li\-ter– this is termed \textit{Impaired Fasting Glucose (IFG)\index{Impaired fasting glucose (IFG)}}.
\item A 2–hour blood sugar level is between 140 to 200 mg per deciliter after the OGTT (\textit{oral glucose tolerance test})\index{Oral glucose tolerance test (OGTT)} – this is termed impaired glucose tolerance (IGT).
\end{enumerate}
...
\noindent\textbf{How do \textit{glitazones\index{Glitazones}} work?}
...
\noindent\textbf{Possible side effects of \textit{glitazones\index{Glitazones}}}
...
\textbf{\textit{Starch Blockers\index{Starch blocker}}}

\textbf{\textit{Alpha–Glucosidase} Inhibitors (AGI)\index{Alpha Glycosidase inhibitors (AGI)}}
...
There is some concern that this class of medications can increase the risk of \textit{pancreatitis\index{Pancreatitis}} (inflammation of the pancreas) and pancreatic cancer. The FDA in USA is reviewing this currently.
...
\noindent{\textbf{\textit{Insulin\index{Insulin}} in the treatment of Diabetes}}
...
\hline
 & \,\,\,\,\quad\textbf{Intensive insulin} & \,\textbf{Conventional}\\
 & \,\,\qquad\quad\textbf{therapy} & \,\,\quad\textbf{therapy}\\
\hline
...
Stress is a part of everyday life, and has been so from time immemorial. Stress is the body’s response to a threat or adversity, which could be real (such as injury or illness) or imaginary (fear, anxiety about something, etc). Stress is an attempt by the body to deal with the adversity by what is known as the “flight–or–fight” response, i.e. you will either avoid the problem, or stand up and face it. As part of this process, the body produces several stress hormones. Chief among them are \textit{adrenaline\index{Adrenaline}, cortisol\index{Cortisol}, glucagon} and growth hormone. All these hormones cause more glucose to enter the blood stream because there is an increase in the energy requirement of the human cells as the body deals with the stress. In general, once the source of the stress is gone, the body also relaxes from its hyper vigilant state.
...
\noindent{\large\textbf{Role of \textit{Yogaasanas} and \textit{Dhyana} in Diabetes}}
...
\centering
\includegraphics[scale=1]{images/091.jpg}\\
\textbf{\textit{Pranayama}}
\vskip -.6cm
\end{wrapfigure}
...
ndrasana &  &  &  & \\
\hline
\multicolumn{5}{@{}l}{* p \textless 0.01 ** p \textless 0.001}
\end{longtable}
\end{center}
}\relax
...
\hline
\multicolumn{3}{@{}l}{* p \textless 0.05 ** p \textless 0.001}
\end{tabular}
\end{table}
}\relax
...
Adults with diabetes do not have to abstain from alcohol. Indeed, the guidelines for alcohol use in individuals with diabetes mirror those for the general population. However, restrictions or abstinence from alcohol are necessary in some situations as explained in chapter–\ref{chap22}.
