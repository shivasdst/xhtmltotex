...
\textit{Teneligliptin} was introduced in India in May 2015. It has gained popularity and is widely used in type 2 diabetes as it is cost effective and efficacious.
...
\begin{enumerate}[•]
\itemsep=0pt
\item Store insulin in the refrigerator. More specifically, store it in the door pockets, and not inside the refrigerator (shown in picture, p.~ 229). This protects insulin from variations in temperature when we open the refrigerator.
