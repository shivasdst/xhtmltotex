...
\colorblue{\textbf{History of diabetic diets}}
...
\colorblue{Diabetic diet in the 21st century}
...
\begin{figure}
\includegraphics{images/078.jpg}
\end{figure}
...
\end{tabular}{}
\textbf{The problem with simple sugars}
...
\begin{figure}
\includegraphics{images/079.jpg}
\end{figure}
...
\begin{figure}
\caption{\textbf{Blood sugar level after eating}}
\includegraphics{images/080.jpg}
\end{figure}
...
Protein is found in many sources, both plant and animal based.
...
\begin{myquote}
Note: Remember that LDL is the bad cholesterol that you do not want, and HDL is the good cholesterol that you do want in your blood.
\end{myquote}
...
\colorblue{Artificial sweeteners}
...
\end{tabular}{}
\colorblue{Vitamins and Minerals}
...
\colorblue{A spicy way to control blood sugar: the role of spices in a diabetic’s diet}
...
\colorblue{Alcohol and diabetes}
...
\chapter{Prevention of Diabetes}
