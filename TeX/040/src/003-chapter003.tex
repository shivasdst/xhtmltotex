...
\item \textbf{Any number of doctors, any number of Governments, any number of NGO's will not be able to contain Global Diabetes menace unless preven\-tive steps are taken at all levels starting from adolence. Creating global awareness on diabetes is the mantra for primary prevention.}
