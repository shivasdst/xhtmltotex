...
\part{\textbf{Part II - The complications of Diabetes}}
...
\begin{enumerate}
\itemsep=0pt
\item Diabetic keto acidosis\index{Diabetic Keto Acidosis}
\item Hyperosmolar hyperglycemic state\index{Hyperosmolar Hyperglycemic State}
\item Hypoglycemia\index{Hypoglycemia}
\end{enumerate}
...
This condition develops when there is a severe shortage of insulin in the body. As explained in the previous chapters, insulin is critical to help glucose enter the human cells. Glucose is the main source of energy for the human cell. But in the absence of insulin, glucose cannot enter the cell and provide this energy. So the human body is forced to tap into alternative sources of energy such as body fat and muscles. But burning body fat as a source of energy results in accumulation of acids known as ketones in the body. This causes a condition known as metabolic acidosis\index{Metabolic Acidosis}.
...
\includegraphics[scale=2.4]{images/035.jpg}
\vskip-.5cm
\end{figure}
...
%~ \rhead[\small \em Acute Complications of Diabetes]{\small\thepage}
...
Cardiovascular disease\index{Cardiovascular disease} is the number one killer in diabetes. It refers to disease of the blood vessels in the human body. \textcolor{blue}{The total length of all blood vessels in the human body is approximately 60,000 miles, and diabetes can affect every inch of this network!}
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.8]{images/037.jpg}\\
...
\includegraphics[scale=1.3]{images/038.jpg}
\vskip-.5cm
\end{wrapfigure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=2.4]{images/040.jpg}
\vskip-.1cm
\end{figure}
...
\noindent{\textbf{STROKE\index{Stroke}}}
...
\item A less common cause is due to a blood vessel that bursts open due to very high pressure inside it. This is called a “hemorrhagic stroke”\index{Haemorrhagic stroke}, since there is hemorrhage or bleeding from the burst\break vessel. This type of stroke is usually a consequence of high blood pressure.
\end{enumerate}
\vspace{-\topsep}
...
Diabetics are also more prone to have unhealthy cholesterol\break patterns, and this is termed “diabetic dysplipidemia”\index{Diabetic dysplipidemia}, and is explained in more detail in chapter \ref{chap13B}.
...
\item Have a routine cardiac check up. Irregular heart rhythm (called atrial fibrillation\index{Atrial fibrillation}) is a major risk factor for stroke. Taking a blood thinner such as aspirin or warfarin can significantly reduce this risk.
\end{enumerate}
\vspace{-\topsep}
...
Hypertension\index{Hypertension} or high blood pressure is commonly seen in approximately 60\% of diabetics.
...
\begin{thebibliography}{99}
%~ \rhead[\small \em Hypertension and Diabetes]{\small\thepage}
...
Cholesterol\index{Cholesterol} is a soft waxy substance present both in blood and inside\break human cells. It is a form of fat. The word cholesterol originates from the Greek words ‘chole’ meaning bile and ‘sterol’ meaning solid. In other words, solidified fat seen in bile juice. The liver secretes bile juice, and the liver is the main source of cholesterol synthesis.
...
\centering
\textbf{\textit{Coronary arteries \& Plaque formation:}}\\
\includegraphics[scale=1.9]{images/041.jpg}
\end{figure}

Unfortunately people with diabetes are prone to having unhealthy cholesterol levels, and hence are at higher risk of cardiac disease. This condition is termed “diabetic dyslipidemia.”\index{Diabetic dyslipidemia}
...
Cholesterol levels are checked by a blood test known as ‘lipid\break panel’. This should be checked after an overnight fast to avoid\break inaccuracies. Recent ADA guidelines recommend lipid estimation\break after food also.
...
\chapter{Kidney Disease in Diabetes}\index{Kidney Disease}\label{chap14}
...
\vskip-.5cm
\centering
\includegraphics[scale=1.2]{images/042.jpg}
\vskip-.5cm
\end{wrapfigure}
...
\centering
\textbf{\textit{Structure of Nephron}}\\
\vskip 3pt
\includegraphics[scale=1.4]{images/043.jpg}
\vskip-.6cm
\end{wrapfigure}
...
\centering
\includegraphics[scale=1.4]{images/044.jpg}
\vskip-.5cm
\end{wrapfigure}
...
\includegraphics[scale=1.4]{images/045.jpg}
\vskip-.4cm
\end{wrapfigure}
...
\item Anemia\index{Anemia}: Damaged kidneys stop producing erythropoietin, the\break hormone essential to stimulate the bone marrow to produce red\break blood cells. This results in anemia. The anemia causes immense\break fatigue. Frequent blood transfusions may be required to treat this anemia.
...
\item Acidosis\index{Acidosis}: Several acids that are normally excreted in urine start\break accumulating to toxic levels in kidney failure. This lowers the pH of the body, and all biochemical processes become erratic and rapidly shut down causing death!
\item Malnutrition\index{Malnutrition}: Accumulation of poisonous urea and acids cause\break severe anorexia (lack of appetite), which causes severe malnutrition, and deterioration of overall health.
\end{enumerate}
\vspace{-\topsep}

\noindent{\textbf{Dialysis\index{Dialysis}}}
...
\noindent{\textbf{Kidney transplant\index{Kidney transplant}}}
...
\begin{thebibliography}{99}
%~ \rhead[\small \em Kidney Disease in Diabetes]{\small\thepage}
...
\begin{figure}[h]
\centering
\includegraphics[scale=2.4]{images/046.jpg}
\vskip-.3cm
\end{figure}
...
\noindent\textbf{Cataracts}\index{Cataract}
...
\begin{figure}[h]
\centering
\includegraphics[scale=3.4]{images/047.jpg}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=2.2]{images/048.jpg}
\end{figure}
...
\noindent\textbf{Diabetic retinopathy}\index{Diabetic retinopathy}

\begin{figure}[h]
\centering
\includegraphics[scale=1.3]{images/049.jpg}\\
\textbf{\textit{Healthy Retina}}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[scale=1.3]{images/050.jpg}\\
\textbf{\textit{Diabetic Retinopathy}}
\vskip-.5cm
\end{figure}

This is a general term for all disorders of the retina caused by\break diabetes. It is the most common of the so–called ‘microvascular\break complications’ of diabetes, the other two being nephropathy\index{Nephropathy} (kidney\break damage) and neuropathy\index{Neuropathy} (nerve damage). Microvascular complications refer to diseases that occur as a result of damage to small (or micro) blood vessels.
...
\includegraphics[scale=1.4]{images/051.jpg}
\vskip-.4cm
\end{wrapfigure}
...
\includegraphics[scale=1.4]{images/052.jpg}
\end{wrapfigure}

Further progression of the disease leads to the next stage called “proliferative retinopa\-thy”\index{Proliferative retinopathy}. During this stage, the damage to the blood vessels continues to the point where they completely shut down. In response, new capillaries or blood vessels start growing into the retina (hence the term ‘proliferative’, since there is a proliferation of new blood vessels). But alas! these new recruits are not as sturdy as the original ones. They are weak, and leak blood into the vitreous, a condition called ‘vitreous hemorrhage’. In addi\-tion, these new blood vessels end up in scar tissue formation in the eye. This scar tissue shrinks over time, and when that happens, it pulls on the retina, causing the retina to\break detach, resulting in ‘retinal deta\-chment’. Both vitreous hemorrhage and retinal detachment\index{Retinal detachment} can cause blindness.
...
\begin{thebibliography}{99}
%~ \rhead[\small \em Diabetic Eye Disease]{\small\thepage}
...
%~ \rhead[\small \em \leftmark]{\small\thepage}
\chapter{Diabetic Neuropathy}\index{Diabetic Neuropathy}\label{chap16}
...
Finally, diabetes can also affect the cranial nerves, or the nerves inside our skull. Most commonly the 3rd and 6th cranial nerves are affected. These nerves control the movements of the eyeball. As a\break result patient often have diplopia\index{Diplopia} or “double vision”, due to inability of the two eyeballs to focus on a single object.
...
\begin{thebibliography}{99}
%~ \rhead[\small \em Diabetic Neuropathy]{\small\thepage}
...
Diabetes exploits this vulnerability by causing ulcers, infections, and bone damage in the feet. This is loosely termed “Diabetic Foot\break Disease”\index{Diabetic foot disease}.

\begin{wrapfigure}{r}{4.5cm}
\vskip -.4cm
\centering
{\small\textbf{\textit{Skin and fat form a protective “cushion” that absorbs pressure and protects your foot from infection}}}\\
\includegraphics[scale=.8]{images/053.jpg}
\end{wrapfigure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=2.3]{images/054.jpg}
\vskip-.1cm
\end{figure}
...
\item Charcot’s joint\index{Charcots joint}
\end{enumerate}
...
\begin{wrapfigure}{r}{4.5cm}
\centering
\includegraphics[scale=.8]{images/055.jpg}\\
...
\begin{center}
\begin{tabular}{@{}ccc@{}}
\includegraphics[scale=.7]{images/056.jpg} &
\includegraphics[scale=.8]{images/057.jpg} &
...
\begin{center}
\begin{tabular}{@{}c@{}}
\includegraphics[scale=.7]{images/059.jpg}\\
...
\begin{figure}[h]
\centering
\includegraphics[scale=.6]{images/060.jpg}\\
...
\vspace{-\topsep}
 \begin{figure}[h]
\centering
\includegraphics[scale=1]{images/061.jpg}
\end{figure}
\vspace{-\topsep}
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.2]{images/062.jpg}
\end{figure}
\vspace{-\topsep}
...
\begin{figure}[h]
\centering
\includegraphics[scale=2.4]{images/063.jpg}\\
...
\noindent{\textbf{Stage 5 of the diabetic ulcer – Diabetic gangrene\index{Diabetic gangrene}}}
...
\includegraphics[scale=.9]{images/065.jpg}\\[3cm]
{\small\textbf{\textit{Picture: 1}}} & {\small\textbf{\textit{Picture: 2}}}
\end{tabular}
\vspace{-\topsep}
\end{center}
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.1]{images/066.jpg}\\
{\small\textbf{\textit{Picture: 3}}}
\vskip -.4cm
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=1]{images/067.jpg}\\
...
\begin{figure}[h]
\centering
\includegraphics[scale=2.1]{images/068.jpg}\\
...
\noindent{\textbf{Charcot joint\index{Charcots joint}}}
...
\begin{wrapfigure}{l}{5cm}
\centering
\includegraphics[scale=1.7]{images/069.jpg}\\
...
\begin{enumerate}[•]
\itemsep=0pt
\item Stye\index{Stye} (infection of glands along the edges of the eyelids)
\item Boils
\item Folliculitis\index{Folliculitis} (infection of the hair follicle)
\item Carbuncles\index{Carbuncle} (infection of skin and its deeper tissue, commonly located on the nape of the neck. Since these lesions used to be seen among the aristocrats, it was called \textit{“raasapundu”} in Telugu language)
\end{enumerate}
\vspace{-\topsep}
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.1]{images/070.jpg}
\end{figure}
...
\includegraphics{images/071.jpg} & and is mostly &  & diabetes, if not\\
...
\centering
\includegraphics[scale=1]{images/073.jpg}
\vskip-.2cm
\end{wrapfigure}
...
\vskip-.3cm
\centering
\includegraphics[scale=.9]{images/074.jpg}
\vskip-.3cm
\end{wrapfigure}

This can be seen in up to 35\% of diabetics and is thought to be a result of poorly controlled disease. The skin on the hands becomes thick, waxy and tight. When these patients are asked to bring their hands together, they are\break unable to do so, and form what is known as the “prayer hand”. This\break condition causes an inability to move the fingers properly, and can severely limit even simple tasks like\break holding a glass, writing, etc. Physiotherapy and good blood sugar\break control can slow down the disease.
...
\vskip-.4cm
\centering
\includegraphics[scale=1.5]{images/075.jpg}\\
\textbf{\textit{Picture showing the role of Vagus nerve\\ to control the movements of the stomach}}
\vskip-.5cm
\end{figure}
...
When diabetes is not well controlled, the high blood sugars\break affect the various nerves in our body. This is known as neuropathy\index{Neuropathy}.\break Neuropathy will eventually affect the vagus nerve too. The excess\break blood glucose becomes toxic for the nerve. Slowly the vagus nerve starts to loose control over the stomach muscles. The plight of the stomach muscles is like that of an army without a leader, which has\break no idea about which direction to march in! Thus the muscles fail to\break propel food forward, and food gets stuck in the stomach for long\break periods of time. It is as if the stomach muscles are paralysed, and hence the name ‘gastroparesis’ or ‘paralysis of the stomach’.
...
\noindent\textbf{What are the complications of gastroparesis?\index{Gastroparesis}}
...
\item Bezoar formation\index{Bezoar formation}. When food is stuck inside the stomach for\break prolonged periods, the food can become hard and turn into a solid mass known as bezoar.
\end{enumerate}

\begin{wrapfigure}{r}{4.9cm}
\vskip -.4cm
\centering
\includegraphics[scale=1.2]{images/076.jpg}\\
...
\noindent\textbf{What is impotence or erectile dysfunction?\index{Erectile dysfunction}}
...
The autonomic nervous system is in charge of mobilizing the small blood vessels that supply the penis. It is only when these small blood vessels dilate and allow more blood flow through them into the chambers of the penis (corpora\break cavernosa), that an erection becomes possible. But diabetes affects the autonomic nervous system. Thus, even though a desire arises in our mind, the nerves are unable to translate this desire into an erection.
 ...
 \item \textbf{Vasculopathy\index{Vasculopathy}:}
