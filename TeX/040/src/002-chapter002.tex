...
\item Malnutrition\index{Malnutrition}: Accumulation of poisonous urea and acids cause severe anorexia (lack of appetite), which causes severe malnutrition, and deterioration of overall health.
\end{enumerate}
\vspace{-\topsep}
...
\includegraphics[scale=.9]{images/068a.jpg}\\[3cm]
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.1]{images/068b.jpg}\\
...
\begin{figure}[h]
\centering
\includegraphics[scale=1]{images/069.jpg}\\
...
\begin{figure}[h]
\centering
\includegraphics[scale=2.1]{images/070.jpg}\\
...
\item Bezoar formation\index{Bezoar formation}. When food is stuck inside the stomach for prolonged periods, the food can become hard and turn into a solid mass known as bezoar.
\end{enumerate}
