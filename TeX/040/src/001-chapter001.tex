...
Hippocrates also described the symp\-toms of diabetes in the 4th century B.C. Hippocrates is widely considered as the “father of modern medicine”. He autho\-red the ‘Hippocratic Oath’, the original docu\-ment on the ethics of medical pra\-ctice. Even to this day it serves as a 
...
Thomas Willis went on to call this\break disease a “pissing evil”, since it manifests as excess urination, and noted that in\break patients with diabetes “the urine is wonderfully sweet, as if imbued with honey or sugar”.
...
\centering
\includegraphics[scale=.5]{images/009.jpg}\\
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.1]{images/019.jpg}\\
...
\includegraphics[scale=1.5]{images/021.jpg}
\end{figure}
...
Management of this condition presents several extraordinary challe\-nges:
...
\includegraphics[scale=1.1]{images/026.jpg}\\
...
\includegraphics[scale=1.4]{images/027.jpg}\\
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.5]{images/028.jpg}\\
...
\includegraphics[scale=1.6]{images/031.jpg}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.6]{images/032.jpg}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[scale=1.6]{images/033.jpg}
\end{figure}
...
\includegraphics[scale=1.5]{images/035.jpg}
\end{figure}
...
\includegraphics[scale=1.5]{images/037.jpg}
\textbf{\textit{Note: Figures expected to Jump 55\% by 2035}}
\end{figure}

\noindent\textbf{Figure: 4.}

Globally, diabetes hits particularly “middle–aged” people between 40 to 59 years of age which causes serious economic and social implications. More than this, diabetes affects especially low and middle income countries, as 77\% of all people with diabetes worldwide live in those countries. Eg: In India, diabetes is fast becoming disease of the poor. Figure 1 summarizes the growing burden of the global diabetes epidemic.\cite{chap9–key01-key04}.

It is interesting to note that diabetes more or less equally affects both sexes with men having a small edge over women at younger age groups and women surpassing men at higher age groups.\cite{chap9–key01, key02}
