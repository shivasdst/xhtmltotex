...
\long\def\shloka{\vskip 5pt\vbox\bgroup\ignorespaces\noindent\fontsize{13.5pt}{15.5pt}\selectfont\bfseries\leftskip=1.6cm}
\long\def\endshloka{\egroup\par\vskip 5pt}

\newenvironment{artha}[1]{\par\bgroup\noindent\fontsize{11pt}{13pt}\selectfont\leftskip=\parindent\rightskip=\parindent#1}{\par\egroup}
...
\def\indentsecionsintoc{\addtocontents{toc}{\protect\bgroup\leftskip=1.5em \rightskip=2.3em\fontsize{10}{12}\selectfont\noindent}}
...
\chead[{\fontsize{10}{12}\selectfont ಗೀತಾಭಾವಧಾರೆ}]{{\fontsize{10}{12}\selectfont\leftmark}}
\lfoot[]{}
\rfoot[]{}
\cfoot[]{}
